  ...
  <v-form ref="form" autocomplete="nope" @submit.prevent="setCaptcha">
    <v-row dense>
      ...
      <v-col cols="12" pb-2>
        <label class="ld-form-p2">
          DNI del referidor
          <span class="body-2">(opcional)</span>:
        </label>
      </v-col>
      <v-col cols="12" md="6">
        <v-text-field
          v-model="datos.codigoReferidos"
          v-validate="'numeric|max:8|min:8'"
          label="Ingresa el DNI del referidor"
          :error-messages="errors.collect('datos.codigoReferidos')"
          data-vv-name="datos.codigoReferidos"
          data-vv-as="Referidos"
          :color="color"
          :maxlength="8"
          :counter="8"
          type="tel"
