          ...
          <v-hover>
            <template v-slot="{ hover }" >
              <v-card
                ...
                @click.prevent="verMas(item.placa, item.importeDesembolso,
                                        item.importeCuotas,
                                        item.cuotas,item.importeFinanciar,
                                        item.deudaVigente,
                                        item.factorRecaudo,
                                        item.tasa,
              ...
              >
                <div class="d-flex flex-no-wrap" >
                  <v-row>
                    ...
                    <v-col cols="9" lg="8" md="8" sm="8" class="d-flex flex-column justify-center">
                      <div class="card-text"  >
                        <v-card-text style="line-height: 70%;font-size: 0.8em">
                          <div >
                            <p style="color: #ff7729;">
                              <strong>Monto a Financiar: S/. {{item.importeFinanciar}}</strong>
                            </p>
                            <p>Cuota Mensual: S/. {{item.importeCuotas}}</p>
