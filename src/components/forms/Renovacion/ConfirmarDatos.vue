        ...
        <form>
          ...
          ></v-text-field-->
            ...
            <v-row justify="center">
              ...
              >
                <v-row>
                  <v-col class="d-flex mt-7" cols="12">
                    <v-select
                      dense
                      :error-messages="errors.collect('cuentasBancos')"
                      v-validate="'required'"
                ...
                if (this.newCI == '' || this.newCCI == '') {
                  ...
                  if (
                    (this.newCI.length < this.longitudMax &&
                      !(this.newCI.length == 10 && this.codigoBanco == 3)) ||
                    ...
                    if (
                      ...
                      let datosForm = {
                        ...
                        canal: 1, //añadido
                        codigoProspecto: this.ofertas.codigoProspecto, //this.datos.codigoProspecto,
                        codigoEvaluacion: this.ofertas.codigoEvaluacion,
                        estadoProspecto: this.ofertas.estadoProspecto, //this.datos.estadoProspecto,
                      ...
                      console.log("verificar esto urgente",datosForm);
