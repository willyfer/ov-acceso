    ...
    <v-dialog v-model="estadoModalFinal" persistent :max-width="'500'">
      <v-card>
        ...
        >
          <p>
            <b>
              En 72 horas hábiles como máximo realizaremos la transferencia de
              tu préstamo en la cuenta bancaria registrada.
            </b>
          </p>
        </v-card-text>
        <!--v-card-text>
...
import { async } from 'q'
import DocumentoFirmar from '@/components/forms/Renovacion/DocumentoFirmar'
    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          title: 'CartaCancelacionCredito',
          title2: 'Carta de Cancelación de Crédito'
        }
      ],
      dialog: false,
      FirmaReady: 1,
