        ...
        <v-row class="d-flex flex-row justify-center ma-0" cols="12">
          <v-col cols="12" sm="12" md="12">
            <v-row class="d-flex flex-column flex-nowrap">
              ...
              <v-row class="mx-0 divider-container d-flex align-center">
...
<script>
import OfertaItem from '@/components/forms/Renovacion/OfertaItem'
