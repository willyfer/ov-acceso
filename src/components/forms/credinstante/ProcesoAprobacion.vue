    ...
    <v-col class="text-center">
      <template v-if="!isSimulador">
        ...
        <CreditDetails
          ...
          :importeFinanciar="datos.importeFinanciar"
          :importeCostoPos="datos.importeCostoPos"
          :importeCuotas="datos.importeCuotas"
          :tasa="datos.tasa"
          :cuotas="datos.cuotas"
        />
        <div v-if="datos.codigoProducto !== 35" class="secondary--text" style="font-size: 12px">
        ...
        <div v-if="isBtnConfirmar">
          <v-row class="d-flex flex-row justify-center mt-4" md="6">
            <v-col
              v-if="isDetallePrestamo"
              md="12"
              class="d-flex flex-row justify-center pb-0"
            >
              <v-btn
      ...
      <template v-else>
        ...
        <CreditSimulationLD
          :montoMinimo="datos.importeFinanciarMinimo"
          :montoMaximo="datos.importeFinanciarMaximo"
          :listaPlazos="plazos"
   ...
   async simular(payload) {
    ...
    async confirmarSimulacion(payload) {
      ...
      await this.$store.dispatch('express/actionConfirmarSimulacion', {
        ...payload,
        prospecto: this.datos.codigoProspecto,
      })
      this.loading = false
    },
  },
